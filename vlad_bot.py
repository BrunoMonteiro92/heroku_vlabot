    ...
    if (command.startswith('/')):
        ...
        if command == '/vlad' or command == '/vlad@vlademeeer_bot':
            ...
            if op == "Te fode carlos":
                ...
                op.replace("carlos", name.split()[0])
        ...
        if command == '/fera' or command == '/fera@vlademeeer_bot':
            ...
            if not p.isdigit():
                ...
                bot.sendMessage(chat_id, "Ma... Eu acho que *" +
                                p.upper() + "* nao eh um numero", parse_mode='Markdown')
            else:
                p = int(p)
                if p < 0 or p > len(pics)-1:
                    ...
                    bot.sendMessage(chat_id, "Ei... Éééééé... Tem que tá dentro do intervalo de *[0 até " + repr(
                        len(pics)-1) + "]*", parse_mode='Markdown')
                else:
        ...
        if command == '/diz' or command == '/diz@vlademeeer_bot':
            ...
            if not a.isdigit():
                ...
                bot.sendMessage(chat_id, "Ma... Eu acho que *" + a.upper() +
                                "* nao eh um numero ", parse_mode='Markdown')
            else:
                a = int(a)
